...
using controllers::AttractivePotentialField;

// CONSTRUCTORS/DESTRUCTORS
AttractivePotentialField::AttractivePotentialField() {
    scaling_factor_ = 1.0;
    goal_pos_.setZero();
    goal_quat_.setIdentity();
}

AttractivePotentialField::AttractivePotentialField(dynacore::Vect3 goal_pos, dynacore::Quaternion goal_quat) {
    scaling_factor_ = 1.0;
    goal_pos_ = goal_pos;
...
// GETTERS/SETTERS
void AttractivePotentialField::getGoal(dynacore::Vect3& goal_pos_out, dynacore::Quaternion& goal_quat_out) {
    goal_pos_out = goal_pos_;
    goal_quat_out = goal_quat_;
    return;
}

void AttractivePotentialField::setGoal(dynacore::Vect3 goal_pos_in, dynacore::Quaternion goal_quat_in) {
...
double AttractivePotentialField::distanceToGoal(dynacore::Vect3 curr_pos, dynacore::Quaternion curr_quat) {
...
double AttractivePotentialField::potential(dynacore::Vect3 curr_pos, dynacore::Quaternion curr_quat) {
...
void AttractivePotentialField::gradient(dynacore::Vect3 curr_pos, dynacore::Quaternion curr_quat,
...
void AttractivePotentialField::getDx(dynacore::Vect3 curr_pos, dynacore::Quaternion curr_quat,
